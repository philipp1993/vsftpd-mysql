...
parseconf_bool_array[] =
{
  ...
  { "root_enable", &tunable_root_enable },
  ...
  { "dirmessage_always", &tunable_dirmessage_always },
  ...
  { "ssl_nonforce_file_enable", &tunable_ssl_nonforce_file_enable },
...
parseconf_uint_array[] =
{
	...
	{ "mysql_database_port", &tunable_mysql_database_port },
	{ "mysql_database_connectionflags", &tunable_mysql_database_connectionflags },
  { 0, 0 }
};
...
parseconf_str_array[] =
{
	...
	{ "ssl_nonforce_file", &tunable_ssl_nonforce_file },
	...
	{ "mysql_database_username", &tunable_mysql_database_username },
	{ "mysql_database_password", &tunable_mysql_database_password },
	{ "mysql_database_host", &tunable_mysql_database_host },
	{ "mysql_database_socketname", &tunable_mysql_database_socketname },
	{ "mysql_database_dbname", &tunable_mysql_database_dbname},
	{ "mysql_database_tablename", &tunable_mysql_database_tablename},
  { 0, 0 }
};
